    ...
    >
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <p
            className="font-sans text-sm max-w-lg mx-auto mt-4"
            style={{ color: "rgba(245,240,232,0.6)" }}
          >
            Namun jika Anda ingin memberikan tanda kasih untuk kami, Anda dapat
        ...
        >
          <button
            ...
            style={{
              background:
                activeTab === "transfer"
                  ? "linear-gradient(135deg, #D4AF37 0%, #F5E070 100%)"
                  : "rgba(26,20,8,0.5)",
              border:
                activeTab === "transfer"
            ...
            {activeTab === "transfer" && (
              ...
              >
                {weddingData.bankAccounts?.map((bank, index) => (
                  <div
                    key={index}
                    className="glass-card p-6 md:p-8 flex flex-col items-center text-center relative overflow-hidden group"
                  >
                    <button
                    ...
                    <p
                      className="font-mono text-2xl mb-2 tracking-wider"
            ...
            {activeTab === "kado" && (
              ...
              >
                <div className="glass-card p-6 md:p-8 flex flex-col items-center text-center relative overflow-hidden group">
                  <button
                    onClick={() =>
                      handleCopy(weddingData.shippingAddress || "")
                    }
                    className="absolute top-4 right-4 p-2 text-gold-500 hover:text-white transition-colors bg-black/20 rounded-full group-hover:bg-black/40"
                    title="Salin Alamat"
                  >
                    {copiedText === weddingData.shippingAddress ? (
                      <CheckCircle2 size={18} />
                    ) : (
                      <Copy size={18} />
                    )}
                  ...
                  <div
                    className="w-16 h-px mb-6 mt-4"
                    style={{ background: "rgba(212,175,55,0.4)" }}
                  />
                  <p
                    className="font-sans text-base leading-relaxed whitespace-pre-wrap max-w-sm"
